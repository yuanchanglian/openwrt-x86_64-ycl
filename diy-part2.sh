...
# Modify default IP
sed -i 's/192.168.1.1/192.168.10.66/g' package/base-files/files/bin/config_generate
# 删除自定义源默认的 argon 主题
...
#git clone https://github.com/kenzok78/luci-app-fileassistant package/lean/luci-app-fileassistant
